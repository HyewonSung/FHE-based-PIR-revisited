...
EXPORT void init_LagrangeHalfCPolynomial(LagrangeHalfCPolynomiala *obj, const int32_t N) {
    new(obj) LagrangeHalfCPolynomial_IMPL(N);
}
EXPORT void init_LagrangeHalfCPolynomiala_array(int32_t nbelts, LagrangeHalfCPolynomiala *obj, const int32_t N) {
...
EXPORT void destroy_LagrangeHalfCPolynomial(LagrangeHalfCPolynomiala *obj) {
    LagrangeHalfCPolynomial_IMPL *objbis = (LagrangeHalfCPolynomial_IMPL *) obj;
    objbis->~LagrangeHalfCPolynomial_IMPL();
}
EXPORT void destroy_LagrangeHalfCPolynomial_array(int32_t nbelts, LagrangeHalfCPolynomiala *obj) {
    LagrangeHalfCPolynomial_IMPL *objbis = (LagrangeHalfCPolynomiala_IMPL *) obj;
    for (int32_t i = 0; i < nbelts; i++) {
...
#ifndef __AVX2__
EXPORT void LagrangeHalfCPolynomialSetTorusConstant(LagrangeHalfCPolynomiala *result, const Torus64 mu) {
...
#ifndef __AVX2__
EXPORT void LagrangeHalfCPolynomialAddTorusConstant(LagrangeHalfCPolynomiala *result, const Torus64 mu) {
    LagrangeHalfCPolynomial_IMPL *result1 = (LagrangeHalfCPolynomial_IMPL *) result;
    const int32_t Ns2 = result1->proc->Ns2;
    double *b = result1->coefsC;
    const double muc = mu; //we do not rescale
...
EXPORT void LagrangeHalfCPolynomialSetXaiMinusOne(LagrangeHalfCPolynomiala *result, const int32_t ai) {
    LagrangeHalfCPolynomial_IMPL *result1 = (LagrangeHalfCPolynomial_IMPL *) result;
    const int32_t Ns2 = result1->proc->Ns2;
...
EXPORT void LagrangeHalfCPolynomialAddTo(
        LagrangeHalfCPolynomiala *accum,
        const LagrangeHalfCPolynomiala *a) {

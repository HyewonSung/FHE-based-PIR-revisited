...
.LHOTB1:
	.p2align 4,,15
	.globl	LagrangeHalfCPolynomialAddMulASM
	.type	LagrangeHalfCPolynomialAddMulASM, @function
LagrangeHalfCPolynomialAddMulASM:
.LFB7135:
	.cfi_startproc
	pushq	%r12
	pushq	%r13
	...
	/* LagrangeHalfCPolynomialAddMul(HCP* r, HCP* a, HCP* b, long Ns2) */
	/* rcx is Ns2 */
	movq	%rdi, %r8  /* r8: base of rre */
	movq    %rsi, %r10 /* r10: base of are */
	movq	%rdx, %r12 /* r12: base of bre */
...
.L42:
	...
	.cfi_endproc
.LFE7135:
	.size	LagrangeHalfCPolynomialAddMulASM, .-LagrangeHalfCPolynomialAddMulASM
	.section	.text.unlikely
.LCOLDE1:
	.text
.LHOTE1:
